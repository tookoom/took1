...
namespace Took1.Devices
{
    ...
    public abstract class DeviceClass : IDisposable
	{
		...
		protected DeviceClass(Guid classGuid, IntPtr hwndParent)
		{
			...
			deviceInfoSet = Native.SetupDiGetClassDevs(ref classGuid, 0, hwndParent, Native.DIGCF_DEVICEINTERFACE | Native.DIGCF_PRESENT);
        ...
        internal string GetProperty(Native.SP_DEVINFO_DATA devData, int property, string defaultValue)
        {
            ...
            if (!Native.SetupDiGetDeviceRegistryProperty(deviceInfoSet,
                devData,
                property,

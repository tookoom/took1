...
namespace TK1.Html.Elements
{
    ...
    /// </summary>
    public class HtmlBody : HtmlContainer, IHtmlElement
    {
        /// <summary>
        /// Construtor.
        /// </summary>
        ...
        public HtmlBody(HtmlAttributeCollection attributes)
        {
        ...
        public HtmlBody(HtmlElementCollection children)
        {
        ...
        /// <param name="children">Coleção de elementos filhos.</param>
        /// <param name="attributes">Coleção de atributos do elemento.</param>
        public HtmlBody(HtmlElementCollection children, HtmlAttributeCollection attributes)
        {
            this.Attributes = attributes;
            this.Children = children;
            if (Children == null)
        ...
        {
            return getContainerHtml("body", identLevel);
        }
    }
}

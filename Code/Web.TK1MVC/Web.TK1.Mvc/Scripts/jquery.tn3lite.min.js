...
h(this);g.fullOnly?l.hide():l.css("visibility","hidden");var k=g.data?g.data:c(l);k=n.push(new h.fn.tn3.Gallery(k,g))-1;l.data("tn3",n[k]);for(var m=0;m<h.fn.tn3.plugins.length;m++)h.fn.tn3.plugins[m].init(l,g,n[k]);l.empty();i(k)});h.fn.tn3.dontLoad?a.call(this,g,g.skinDefault):b.call(this,g);return this};h.fn.tn3.plugins=[];h.fn.tn3.plugIn=function(g,l){h.fn.tn3.plugins.push({id:g,init:l})};h.fn.tn3.version="1.4.0.99";h.fn.tn3.config={data:null,skin:null,skinDir:"skins",skinDefault:'<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
...
this.items.play.click():this.timer.start();this.trigger("init")}},parseLayout:function(){var d=this.items={},i=this.config,j=i.active,f=i.inactive,n=i.cssID.length+1,g=this,l=/MSIE/.test(navigator.userAgent),k,m;this.$c.find("div[class^='"+i.cssID+"-']").each(function(){k=h(this);m=k.attr("class").split(" ")[0].substr(n);if(h.inArray(m,f)!=-1)k.remove();else if(j.length==0||h.inArray(m,j)!=-1)d[m]=k;else m!="gallery"&&k.remove();if(k.parent().hasClass(i.cssID+"-image")){if(!g.$inImage){g.$inImage=
h('<div class="tn3-in-image"></div>');k.parent().append(g.$inImage);if(l){var u=h("<div />");u.css("background-color","#fff").css("opacity",0).css("width","100%").css("height","100%");u.appendTo(g.$inImage)}g.$inImage.css("position","absolute").width(d.image.width()).height(d.image.height())}k.appendTo(g.$inImage)}this.className.indexOf("tn3_")!=-1&&g.addSpecial(m,this.className)});$cm=this.$c;h.each(["albums","album","album-next","album-prev","show-albums"],function(u,q){delete d[q];$cm.find("."+
i.cssID+"-"+q).remove()});var t=h('<div title="Powered by TN3 Gallery"></div>');t.css("position","absolute").css("background-image","url('"+this.config.skinDir+"/tn3.png')").css("background-position","-258px -7px").css("bottom","14px").css("right","53px").css("cursor","pointer").width(40).height(18);t.appendTo(this.$c.find("."+i.cssID+"-gallery"));t.click(function(){window.location="http://tn3gallery.com"}).hover(function(){h(this).css("background-position","-258px -45px")},function(){h(this).css("background-position",
"-258px -7px")})},addSpecial:function(d,i){for(var j=i.split(" "),f,n=0;n<j.length;n++){f=j[n].split("_");if(f[0]=="tn3")if(f[1]=="x")this.special.x[d]=f[2];else{this.special[f[1]].push(d);if(f[1]=="rh"||f[1]=="rv")this.config.initValues[d]={w:this.items[d].width(),h:this.items[d].height()}}}},initHover:function(d,i){var j=this;d.hover(function(){d.addClass(j.config.cssID+"-"+i+"-over")},function(){d.removeClass(j.config.cssID+"-"+i+"-over")})},setTextValues:function(d,i){var j,f,n,g=i+"-";for(n in this.items)if(n.indexOf(g)==
0){j=n.substr(g.length);if(j!="info"&&j!="prev"&&j!="next"){f=i=="image"?this.data[this.cAlbum].imgs[this.n]:this.data[this.cAlbum];if(!f||f[j]==undefined){f={};f[j]=""}else f[j]=h.trim(f[j]);j={field:j,text:f[j],data:f};this.trigger("set_text",j);if(d||j.text==undefined||j.text.length==0){this.items[n].html("");this.items[n].hide()}else{this.items[n].html(j.text);this.items[n].show()}}}},show:function(d,i){this.timer.stop();this.showInit=true;this.imager&&this.imager.show(d);i&&this.fullscreen()},
setAlbumData:function(d,i){if(i)this.trigger("error",{description:i});else{for(var j=0,f=d.length;j<f;j++)this.data.push(d[j]);this.$c&&this.init(this.$c,this.config.fullOnly)}},setImageData:function(d,i,j){if(j)this.trigger("error",{description:j});else{this.displayPreloader(false);d={data:d};this.trigger("image_data",d);this.data[i].imgs=d.data;if(this.cAlbum==i)this.rebuild(d.data,this.showInit?0:this.config.iniImage)}},showAlbum:function(d,i,j){if(this.initialized){if(d>this.data.length)return;
this.timer.stop();this.cAlbum=d;this.albums&&this.albums.hide();if(this.data[this.cAlbum].imgs===undefined)if(this.loader){this.loader.getImages(this.data[this.cAlbum].adata,this.cAlbum);this.displayPreloader(true)}else this.trigger("error",{description:"Wrong album id"});else this.rebuild(this.data[this.cAlbum].imgs,i)}else{this.config.iniAlbum=d;this.config.iniImage=i;this.init(this.$c,false)}j&&this.fullscreen()},rebuild:function(d,i){if(this.items.thumbs)if(this.thumbnailer)this.thumbnailer.rebuild(d);
else this.thumbnailer=new h.fn.tn3.Thumbnailer(this.items.thumbs,d,this.config.thumbnailer);if(this.items.image)if(this.imager)this.imager.rebuild(d);else this.imager=new h.fn.tn3.Imager(this.items.image,d,this.config.image);this.setTextValues(true,"image");this.setTextValues(false,"album");this.trigger("rebuild",{album:this.cAlbum});this.show(i==null?0:i)},showElements:function(d){if(this.areHidden){var i=this,j;h.each(this.special.o,function(f,n){if(i.config.autohideControls){if(n=="prev"&&i.n==
0)return true;if(n=="next"&&i.n==i.imager.data.length-1)return true}j=i.items[n];j.show();if(d&&h.support.opacity){j.stop(true);j.css("opacity",0);j.animate({opacity:1},{duration:d,queue:false})}});this.areHidden=false}},hideElements:function(d){if(!this.areHidden){var i=this,j;h.each(this.special.o,function(f,n){j=i.items[n];if(d&&h.support.opacity){j.stop(true);j.animate({opacity:0},{duration:d,complete:function(){j.hide()},queue:false})}else j.hide()});this.areHidden=true}},setData:function(d){if(this.items.thumbs)this.thumbnailer.data=
...
this.items.fullscreen.attr("title",this.t("Minimize"))}this.onFullResize();this.trigger("fullscreen",{fullscreen:true})}},listenKeys:function(d){if(d.keyCode==70)this.items.fullscreen.click();else if(this.items.albums&&this.albums.enabled){var i=0;switch(d.keyCode){case 27:this.albums.hide();break;case 39:i="r";break;case 37:i="l";break;case 38:i="u";break;case 40:i="d";break;case 32:i="p"}i&&this.albums.select(i)}else switch(d.keyCode){case 27:this.config.isFullScreen&&this.fullscreen(true);break;
case 39:this.show("next");break;case 37:this.show("prev");break;case 38:this.items.albums&&this.albums.show(0,this.cAlbum,false,true);break;case 32:this.items.play.click()}},onFullResize:function(){if(this.config.useNativeFullScreen&&this.nativeFS)this.resize(window.screen.width,window.screen.height);else{var d=h(window),i=d.width();d=d.height();i-=this.config.initValues.wDif;d-=this.config.initValues.hDif;this.resize(i,d)}},resize:function(d,i){this.$tn3.width(d).height(i);var j=d-this.config.initValues.width,
f=i-this.config.initValues.height,n,g,l=this;if(this.items.image){n=this.config.image.initValues.width+j;g=this.config.image.initValues.height+f;if(this.imager)this.imager.setSize(n,g);else{this.items.image.width(n).height(g);this.$inImage.width(n).height(g)}}if(this.items.thumbs){n=this.config.thumbnailer.initValues.width+j;g=this.config.thumbnailer.initValues.height+f;if(this.thumbnailer)this.thumbnailer.setSize(n,g);else this.config.thumbnailer.initValues.vertical?this.items.thumbs.height(g):this.items.thumbs.width(n)}if(this.items.albums){n=
this.albums.initValues.width+j;g=this.albums.initValues.height+f;this.albums.changeSize(j,f)}h.each(this.special.rh,function(k,m){l.items[m].width(l.config.initValues[m].w+j)});h.each(this.special.rv,function(k,m){l.items[m].height(l.config.initValues[m].h+f)});this.center()},center:function(){var d,i=this,j=i.items.image.position();h.each(this.special.v,function(f,n){d=i.items[n];d.css("top",(d.parent().height()-d.height())/2)});h.each(this.special.h,function(f,n){d=i.items[n];d.css("left",(d.parent().width()-
d.width())/2)});h.each(this.special.vi,function(f,n){d=i.items[n];d.css("top",j.top+(i.items.image.height()-d.height())/2)});h.each(this.special.hi,function(f,n){d=i.items[n];d.css("left",j.left+(i.items.image.width()-d.width())/2)});if(this.spinner){this.displayPreloader(true);this.displayPreloader(false)}},trigger:function(d,i){var j=h.Event("tn3_"+d),f;for(f in i)j[f]=i[f];if(i&&i.type!=undefined)j.type="tn3_"+d;j.source=this;this.$c.trigger(j);this.config[d]&&this.config[d].call(this,j);for(f in i)i[f]=
j[f]},initMouseWheel:function(){var d=this,i=function(j){d.show((j.originalEvent.detail?-j.originalEvent.detail:j.originalEvent.wheelDelta)>0?"prev":"next");j.preventDefault()};this.$tn3.bind("mousewheel",i);this.$tn3.bind("DOMMouseScroll",i)},initResponsive:function(d){var i;if(typeof d=="number"){var j=h(window);i=function(){var t=j.width(),u=j.height();this.resize(t*d/100,u*d/100)}}else if(h.isFunction(d))i=d;else if(d!==false){var f=this.$c.parent(),n=(this.config.width==null?this.config.initValues.width:
this.config.width)/(this.config.height==null?this.config.initValues.height:this.config.height),g=f.width(),l=f.height();i=d=="enabled"?function(){g=f.width();l=f.height();this.resize(g,l)}:d=="height"?function(){l=f.height();g=l*n;this.resize(g,l)}:function(){g=f.width();l=g/n;this.resize(g,l)}}var k=this,m=function(){if(k.config.useNativeFullScreen)b.isFullScreen()||h.proxy(i,k)();else h.proxy(i,k)()};h(window).bind("resize",m);m()},replaceMenu:function(d,i){var j='<div style="position:absolute;background-color:#fff;color: #000;padding:0px 4px 0px 4px;z-index:1010;font-family:sans-serif;font-size:12px;">&copy; <a href="'+
i+'">'+d+"</a></div>";this.$tn3.bind("contextmenu",function(f){f.preventDefault()}).bind("mousedown",function(f){if(f.which==3){var n=h(j);h("body").append(n);n.css("left",f.pageX).css("top",f.pageY);n.find("a").mouseup(function(g){window.location=i;n.unbind(g)});h("body").mouseup(function(g){n.remove();h("body").unbind(g)})}})},imageEnter:function(){this.config.timerOverStop&&this.timer.pause(true);this.special.o.length>0&&this.showElements(this.config.overFadeDuration)},imageLeave:function(){this.config.timerOverStop&&
...
doTransition:c});c[0]&&this.initTransition()},initTransition:function(){this.$buffer.css("visibility","visible");if(this.$active!=false){this.isInTransition=true;this.unbindMouseEvents();if(this.mouseIsOver)h(document).mousemove(h.proxy(this.onMouseMove,this));else this.mouseCoor={x:0,y:0};this.lastEnter="leave";this.$active.find("video").length>0&&this.config.transitions[0].type==="translate"?this.ts.start(this.$active,this.$buffer,this.side,true):this.ts.start(this.$active,this.$buffer,this.side)}else{this.$active=
this.$buffer;this.trigger("transition",{n:this.active})}this.startLoading(this.side=="right"?"prev":"next",false)},setSize:function(b,a){this.isInTransition&&this.ts.stop(this.$active,this.$buffer,this.ts.config);this.$c.width(b).height(a);this.cDim={w:this.$c.width(),h:this.$c.height()};if(this.$active){this.$active.width(b).height(a);this.resize(this.$active)}},resize:function(b){if(b.data("img")==undefined)this.trigger("resize",{w:this.cDim.w,h:this.cDim.h,left:0,top:0});else this.cached[this.active].isImage?
this.resizeImage(b):this.resizeContent(b)},resizeImage:function(b){$img=b.data("img");$ic=b.data("ic");$img.width("auto").height("auto");b.data("scaled",false);var a=$img.width(),c=$img.height(),e=0,d=0,i={w:a,h:c,left:0,top:0};$img.attr("width",a).attr("height",c);if($img.get(0).tagName.toUpperCase()=="IMG"&&(a!=this.cDim.w||c!=this.cDim.h)){e=this.cDim.w/a;d=this.cDim.h/c;e=this.config.crop?Math.max(e,d):Math.min(e,d);e=Math.min(this.config.maxZoom,e);a=i.w=Math.round(a*e)-this.config.dif;c=i.h=
Math.round(c*e)-this.config.dif;if(this.cDim.w>=a)e=i.left=(this.cDim.w-a)/2;else{e=-(a-this.cDim.w)*0.5;i.w=this.cDim.w}if(this.cDim.h>c)d=i.top=(this.cDim.h-c)/2;else{d=-(c-this.cDim.h)*0.5;i.h=this.cDim.h}$img.width(a).height(c);$img.attr("width",a).attr("height",c);$ic.width(a).height(c);b.data("scaled",true)}$ic.css("left",e).css("top",d);this.bindMouseEvents($ic);this.trigger("resize",i)},resizeContent:function(b){$ic=b.data("ic");$img=b.data("img");b.data("scaled",false);var a=$img.width(),
c=$img.height(),e={w:a,h:c,left:0,top:0};if(this.config.stretch){$ic.width(this.cDim.w).height(this.cDim.h);$img.width(this.cDim.w).height(this.cDim.h);b.data("scaled",true)}else{e.left=(this.cDim.w-a)*0.5;e.top=(this.cDim.h-c)*0.5;$ic.css("left",e.left).css("top",e.top)}this.bindMouseEvents($ic);this.trigger("resize",e)},onTransitionEnd:function(){this.$active.remove();this.$active=this.$buffer;this.$active.css("width","+=1");this.isInTransition=false;this.trigger("transition",{n:this.active});this.bindMouseEvents(this.$binder);
var b=this.$binder.offset();this.mouseIsOver=false;if(this.mouseCoor.x>=b.left&&this.mouseCoor.x<=b.left+this.$binder.width())if(this.mouseCoor.y>=b.top&&this.mouseCoor.y<=b.top+this.$binder.height()){this.lastEnter="leave";this.enterLeave("enter");this.startIdle();this.mouseIsOver=true;h(document).mousemove(h.proxy(this.onMouseMove,this))}this.qid!=null&&this.show(this.qid)},trigger:function(b,a){var c=h.Event("img_"+b),e;for(e in a)c[e]=a[e];c.source=this;this.$c.trigger(c);this.config[b]&&this.config[b].call(this,

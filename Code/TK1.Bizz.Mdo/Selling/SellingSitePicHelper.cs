...
{
    public class SellingSitePicHelper
    {
        ...
        public SellingSitePicHelper(string rootPath)
        {
        ...
        //}
        //public static List<string> GetSitePics(int customerID, int siteAdID)
        //{
        //    List<string> result = new List<string>();// "~/Images/PicNotFound.jpg";
        //    string url = string.Format("~/Imovel/Fotos/Venda/{0}/{1}/1.jpg", customerID, siteAdID);
        //    if (!string.IsNullOrEmpty(url))
        //        result.Add(url);
